    ...
    return (
        ...
        >
            <Flex align="stretch" gap={40}>
                ...
                >
                    <Flex vertical>
                        <Typography.Title level={4}>{feedback?.topic ? `${feedback?.feedback_type} (${feedback.topic})` : feedback.feedback_type} </Typography.Title>
            ...
            <ActionButtons updateStatus={updateStatus} availableActions={feedback?.availableActions} />
