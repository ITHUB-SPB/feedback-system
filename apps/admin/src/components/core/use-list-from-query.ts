...
} & BaseListProps &
{
    ...
    errorNotification: OpenNotificationParams | false | undefined | ((error: TError) => OpenNotificationParams),
} & UseLoadingOvertimeOptionsProps;
...
>({
    ...
    errorNotification,
    overtimeOptions,
}: UseListFromQueryProps<TQueryFnData, TError, TData>): UseListFromQueryReturnType<
    TData,
    TError
> &
    UseLoadingOvertimeReturnType => {
