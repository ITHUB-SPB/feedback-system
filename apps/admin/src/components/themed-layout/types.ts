...
export type RefineLayoutThemedTitleProps = TitleProps & {
  /**
   *
...
export type BaseRefineThemedLayoutSiderProps = RefineLayoutSiderProps & {
...
export type RefineThemedLayoutSiderProps = BaseRefineThemedLayoutSiderProps & {
  fixed?: boolean;
};
