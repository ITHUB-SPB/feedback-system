...
export type AdministrativeUnitTypeContract = RouterOutput["administrativeUnitType"]
export type OfficialResponsibilityContract = RouterOutput["officialResponsibility"]
